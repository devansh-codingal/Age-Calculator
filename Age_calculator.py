...
if __name__ == "__main__" :
	...
	givenDate = Label(gui, text = "Today's Date", bg = "blue")
	...
	givenDay = Label(gui, text = "Today's Day", bg = "light green")

	# Create a Given Month : label
	givenMonth = Label(gui, text = "This Month", bg = "light green")

	# Create a Given Year : label
	givenYear = Label(gui, text = "This Year", bg = "light green")
